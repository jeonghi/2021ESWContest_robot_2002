...
class Motion:
    ...
    def move_arm(self, arm='HIGH', walk=False, turn=False, dir='FORWARD', loop=1):
        ...
        time.sleep(0.1)
        self.set_head(dir='DOWN', angle=angle_list[level[arm]-1])
        if walk:
            if dir == 'FORWARD':
                for _ in range(loop):
...
<<<<<<< HEAD
                if
=======
>>>>>>> 7769d513a115aa0bbc97c8f08e3a7325b02ffd7d

=======
                self.TX_data_py52(115 + dir_list[dir])
            
                
    
>>>>>>> 944ffb92123bea2c2287cf269bc5407174ba7246
