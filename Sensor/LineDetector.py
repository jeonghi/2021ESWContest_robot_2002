...
class LineDetector:
    ...
    def get_lines(self, src, color='YELLOW'):
        ...
        if len(lines.shape) == 0:
            ...
            horizontal_lines = lines[np.abs(slope_degree) > 150]
            horizontal_slope_degree = slope_degree[np.abs(slope_degree) > 150]
...
if __name__ == "__main__":
    ...
    while True:
        ...
        line_info, edge_info, result = line_detector.get_all_lines(src, line_visualization=False,
