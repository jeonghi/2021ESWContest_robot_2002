...
if __name__ == '__main__':
    ...
    cv2.createTrackbar('Hmax', Top_name, h_max[now_color], 180, Hmax_change)
    cv2.createTrackbar('Hmin', Top_name, h_min[now_color], 180, Hmin_change)
