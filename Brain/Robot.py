...
class Robot:
    ...
    def line_checker(self):
        self.line_info, _ ,  _ = self._image_processor.line_tracing(color=self.color.name, line_visualization = line_visualization, edge_visualization=edge_visualization, ROI=ROI)
